...
#'
#'
summary.bdlim <- function(fit, inter.model, ciprob=.95, hpd.interval=FALSE, ...){
  ...
  out <- list(beta=beta(fit,inter.model=inter.model, ciprob=ciprob, hpd.interval=hpd.interval),
       cumulative=cumulative(fit,inter.model=inter.model, ciprob=ciprob, hpd.interval=hpd.interval),
       w=w(fit,inter.model=inter.model, ciprob=ciprob, hpd.interval=hpd.interval),
       bw=bw(fit,inter.model=inter.model, ciprob=ciprob, hpd.interval=hpd.interval),
       model=m,
